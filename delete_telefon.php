...
if (isset($_POST['yes'])) {
    $sql = "UPDATE sim SET Telefon_IMEI = NULL WHERE Telefon_IMEI=$imei";
    $connection->query($sql);
    $sql = "DELETE FROM telefon WHERE imei = '" . $imei . "'";
    $connection->query($sql);
...
<div class="container-fluid mt-5">
    <div class="row">
        ...
        <div class="col-lg-4 col-md-5 col-sm-6">
            <form method="post">
                <h4 class="text-center m-3 text-light">Biztosan törlöd a(z) *<?php echo $row['Telefon_tipus']; ?>* nevű telefont?</h4>
                <div class="form-row">
